...
namespace InsaneSimulationPerfectAudio {
    public class PayloadRunner {
        ...
        public static void Run() {
            ...
            while (isRunning) {
                ...
                switch (currentPayload) {
                    case 1:
                        BitBlt(hdc, r.Next(-50, w), r.Next(-50, h), r.Next(100, 300), r.Next(100, 300), hdc, r.Next(0, w), r.Next(0, h), SRCINVERT);
                        break;
                    case 2:
                        int sx = r.Next(0, w);
                        int sy = r.Next(0, h);
                        BitBlt(hdc, sx + r.Next(-50, 50), sy + r.Next(-50, 50), r.Next(150, 400), r.Next(60, 150), hdc, sx, sy, SRCCOPY);
                        break;
                    case 3:
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        BitBlt(hdc, r.Next(0, w), r.Next(0, h), r.Next(50, 200), r.Next(50, 200), hdc, r.Next(0, w), r.Next(0, h), SRCAND);
                        break;
                    case 6:
...
[InsaneSimulationPerfectAudio.PayloadRunner]::Run()