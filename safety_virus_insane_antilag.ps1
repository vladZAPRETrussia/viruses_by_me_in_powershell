...
namespace InsaneSimulationOptimized {
    public class PayloadRunner {
        ...
        public static void AudioThread() {
            ...
            wfx.wFormatTag = 1; wfx.nChannels = 1; wfx.nSamplesPerSec = 8000; // Стабильная частота дискретизации
            ...
            // Увеличенный размер буфера для предотвращения лагов и треска
            int bufferSize = 4096;
            ...
            while (isRunning) {
                ...
                Thread.Sleep(200); // Оптимальная задержка для плавного потока
            }
        ...
        public static void Run() {
            ...
            aThread.Priority = ThreadPriority.Highest; // Приоритет звуковому потоку, чтобы не лагал
            aThread.Start();
            ...
            while (isRunning) {
                ...
                Thread.Sleep(5); // Разгружаем процессор, чтобы графика и звук работали стабильно
            }
...
[InsaneSimulationOptimized.PayloadRunner]::Run()